...
const Contact = () => {
  ...
  <div class="py-8 lg:py-16 px-16 mx-auto max-w-screen-md bg-[#5765bda1] rounded-md">
      ...
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about me? Let me know.</p>
